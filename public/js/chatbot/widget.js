!(function (t) {
    ...
    function (t, e, n) {
        ...
        var o = { position: "fixed", bottom: "20px", right: "20px", zIndex: 1000, borderRadius: "5px", boxSizing: "content-box", boxShadow: "0px 0px 20px rgba(0, 0, 0, 0.2)", overflow: "hidden" },
            r = { position: "fixed", bottom: "0px", right: "0px", zIndex: 1000, minWidth: "400px", boxSizing: "content-box", overflow: "hidden", minHeight: "120px" },
            i = { position: "fixed", bottom: "0px", right: "0px", zIndex: 1000, minWidth: "400px", boxSizing: "content-box", overflow: "hidden", minHeight: "120px" },
            a = { position: "fixed", top: 0, right: 0, bottom: 0, left: 0, zIndex: 1000, width: "100%", height: "100%", overflowY: "visible", boxSizing: "content-box" },
            s = {
                height: "40px",
                lineHeight: "30px",
                fontSize: "20px",
            ...
            c = { display: "flex", justifyContent: "center", position: "absolute", top: "0px", right: "20px", height: "120px", width: "120px", padding:"5px", border: 0, borderRadius: "50%", boxShadow: "0px 0px 20px rgba(0, 0, 0, 0.2)" },
            u = { display: "block", position: "absolute", top: "15px", right: "20px", height: "100px", width: "100px", border: 0, borderRadius: "50%", boxShadow: "0px 0px 20px rgba(0, 0, 0, 0.2)" },
                    ...
                    return Object(o.b)(
                        ...
                        Object(o.b)(
                            ...
                            "" === e.bubbleAvatarUrl
                                ? Object(o.b)(
                                      "svg",
                                      { style: { paddingTop: 2 }, fill: "#FFFFFF", height: "24", viewBox: "0 0 24 24", width: "24", xmlns: "http://www.w3.org/2000/svg" },
