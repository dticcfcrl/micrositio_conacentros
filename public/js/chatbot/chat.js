    ...
    function (t, e, n) {
            ...
            for (e && null != e.children && (k.length || k.push(e.children), delete e.children); k.length; )
                if ((o = k.pop()) && void 0 !== o.pop) for (a = o.length; a--; ) k.push(o[a]);
                    ...
                    "boolean" == typeof o && (o = null),
                        ...
                        i && n ? (s[s.length - 1] += o) : s === D ? (s = [o]) : s.push(o),
                        (n = i);
            var c = new r();
        ...
        function b(t, e, n, r, o) {
            ...
            if (((null != e && "boolean" != typeof e) || (e = ""), "string" == typeof e || "number" == typeof e))
                return (
                    t && void 0 !== t.splitText && t.parentNode && (!t._component || o) ? t.nodeValue != e && (t.nodeValue = e) : ((i = document.createTextNode(e)), t && (t.parentNode && t.parentNode.replaceChild(i, t), _(t, !0))),
                    (i.__preactattr_ = !0),
                    i
                );
            var s = e.nodeName;
            ...
            return (
                !I && f && 1 === f.length && "string" == typeof f[0] && null != c && void 0 !== c.splitText && null == c.nextSibling
                    ...
                    : ((f && f.length) || null != c) && g(i, f, n, r, I || null != p.dangerouslySetInnerHTML),
                w(i, e.attributes, p),
                (q = a),
                i
            );
        ...
        function j(t, e, n, r, o) {
            t._disable ||
                ...
                !t.base || o ? t.componentWillMount && t.componentWillMount() : t.componentWillReceiveProps && t.componentWillReceiveProps(e, r),
            ...
            if (!t._disable) {
                ...
                if (
                    (m &&
                        ...
                        (t.state = d),
                        (t.context = h),
                        2 !== e && t.shouldComponentUpdate && !1 === t.shouldComponentUpdate(c, u, l) ? (w = !0) : t.componentWillUpdate && t.componentWillUpdate(c, u, l),
                        (t.props = c),
                        (t.state = u),
                        (t.context = l)),
                    ...
                    if ("function" == typeof N) {
                        var A = p(o);
                        (a = x),
                            a && a.constructor === N && A.key == a.__key ? j(a, A, 1, l, !1) : ((O = a), (t._component = a = C(N, A, l)), (a.nextBase = a.nextBase || b), (a._parentComponent = t), j(a, A, 0, l, !1), M(a, 1, n, !0)),
                            (T = a.base);
        ...
        function N(t, e, n, r) {
            ...
            return (
                o && c && (!r || o._component)
                    ...
                    : (i && !s && (S(i), (t = a = null)), (o = C(e.nodeName, u, n)), t && !o.nextBase && ((o.nextBase = t), (a = null)), j(o, u, 1, n, r), (t = o.base), a && t !== a && ((a._component = null), _(a, !1))),
                t
            );
        }
        function S(t) {
            ...
            function e(n) {
                ...
                return (
                    ...
                    (r.handleSendClick = function () {
                        if (r.input.value.trim() !== "") { // Verifica si el mensaje no está vacío
                            r.say(r.input.value); // Envía el mensaje solo si no está vacío
                            r.input.value = ""; // Limpia el campo de entrada
                        }                    }),
                    (r.writeToMessages = function (t) {
                        void 0 === t.time && (t.time = new Date().toJSON()),
                            void 0 === t.visible && (t.visible = !1),
                            void 0 === t.timeout && (t.timeout = 0),
                    ...
                    r.botman.setChatServer(r.props.conf.chatServer),
                    (r.state.messages = []),
                    (r.state.replyType = s.TextArea),
                    r
                );
            }
            return (
                ...
                (e.prototype.say = function (t, e) {
                    ...
                    this.botman.callAPI(r.text, !1, null, function (t) {
                        var from = "chatbot";
                        if (t.additionalParameters && t.additionalParameters.hasOwnProperty('from')) {
                            from = t.additionalParameters.from;
                        }
                        (t.from = from), n.writeToMessages(t);
                    }),
                ...
                (e.prototype.render = function (t, e) {
                    ...
                    return Object(r.b)(
                        ...
                        Object(r.b)(
                            "a",
                            { class: "banner"},
                            "SendMessage" === this.props.conf.aboutText
                                ? Object(r.b)(
                                      "svg",
                                      { style: "position: absolute; width: 30px; bottom: 6px; right: 6px;", fill: "#737373", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", },
                                      Object(r.b)("path", {
                                          d:
                                          "m3.39401 2.205c.15183-.11584.33366-.18578.52398-.20155.19033-.01577.38119.02328.55002.11255l16.99999 9c.1608.085.2953.2122.3891.368s.1434.3342.1434.516-.0496.3602-.1434.516-.2283.283-.3891.368l-16.99999 9c-.16873.0893-.35949.1284-.54973.1127s-.37202-.0855-.52387-.2011c-.15185-.1157-.26741-.2724-.33305-.4517-.06564-.1792-.0786-.3735-.03735-.5599l1.952-8.784-1.952-8.783c-.04138-.18641-.02853-.38076.03704-.5601.06557-.17933.1811-.33614.33296-.4519zm3.408 10.795-1.356 6.103 11.52799-6.103zm10.17199-2h-10.17199l-1.356-6.103z",
                                      })
                                  )
        ...
        e.a = (function (t) {
            ...
            return (
                ...
                (e.prototype.render = function (t) {
                    ...
                    var height_chat = 500 > window.screen.width ? height - 60 : t.conf.wrapperHeight - 60;
                    var e = "height:" + height_chat + "px;",
                        n = 0;
                    return Object(r.b)(
                        "ol",
                        { class: "chat", style: e },
        ...
        e.a = (function (t) {
            function e() {
                ...
                return (
                    ...
                    (e.scrollTo = function (element, to_element, duration) {
                        var to =  to_element.offsetTop;
                        var prev_elem = $(to_element).prev()[0];

                        var start_prev = prev_elem.offsetTop;
                        var start = start_prev,
                            change = to - start,
                            currentTime = 0,
                            increment = 20;
                    ...
                    (e.scrollToLastMessage = function () {
                        var t = document.getElementById("messageArea");
                        var scroll_messages = document.getElementsByClassName("scroll-message");
                        var last_scroll_message = scroll_messages[scroll_messages.length - 1];
                        t.scrollTop = t.scrollHeight;
                    }),
            ...
            return (
                ...
                (e.prototype.componentDidUpdate = function () {
                    ...
                    if(last_scroll_message){
                        this.scrollTo(t, last_scroll_message, 300);
                        $(".scroll-message").removeClass("scroll-message");
                    } else {
                        this.scrollToBottom();
                    }
                }),
        ...
        e.a = (function (t) {
            ...
            return (
                ...
                (e.prototype.render = function (t) {
                    ...
                    var m = { __html: n.text };
                    return Object(r.b)("div", null, n.text && Object(r.b)("div", { dangerouslySetInnerHTML: m }), this.state.attachmentsVisible ? Object(r.b)("div", null, o) : "");
                }),
                    ...
                    o.a.callAPI(
                        ...
                        function (t) {
                            ...
                            (e.state.attachmentsVisible = !1),
                                e.props.messageHandler({ text: t.text, type: t.type, timeout: t.timeout, actions: t.actions, attachment: t.attachment, additionalParameters: t.additionalParameters, from: from});
                        },
                        null
                    );
                }),
