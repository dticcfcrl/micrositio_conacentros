...
<hr><br>
<div class="card p-3">
    <form action="{{ cp_route('chatbot.configuraciones.update', $configuracion->id) }}" method="POST" class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-md">
        @csrf
        @method('PUT')
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea name="valor" id="valor" required>{{ $valor }}</textarea>
        </div>
        <div class="mb-4">
