...
<div class="flex items-center mb-6">
    ...
    <a href="{{ cp_route('calculadora.configuraciones.create') }}" class="btn-primary">Crear Nueva Configuración</a>
</div>
        ...
        <tbody>
            @foreach($configuraciones as $configuracion)
                <tr>
                    ...
                    <td class="py-2 px-4 border-b border-gray-200 max-w-xs w-1/4">{{ $configuracion->valor }}</td>
                    ...
                    <td class="py-2 px-4 border-b border-gray-200 max-w-xs w-1/4">
                        <a href="{{ cp_route('calculadora.configuraciones.edit', $configuracion->id) }}" class="btn btn-sm btn-primary"><img src="{{ asset('svg/edit.svg') }}" alt="editar" class="w-5 h-5"></a>
                    </td>                   
                </tr>
            @endforeach
        </tbody>
