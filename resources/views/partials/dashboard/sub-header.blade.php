                    ...
                    <div class="d-flex justify-content-between">               
                        ...
                        <div class="text-white">
                            @if(auth()->user()->perfil == 'administrador')
                                <button type="button" class="btn btn-sm btn-danger btn-danger-ccls" data-bs-toggle="modal" data-bs-target="#cancelarModalCitas">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Cancelar citas de hoy">
                        ...
                        <div class="card mb-3">
                            <div class="row w-100">
                                ...
                                <div class="col-md-6 d-flex justify-content-end">
                                    <div class="w-100" id="map-container" style="height: 400px; width: 400px"></div>
                                </div>
                            </div>
                        </div>            
                    </div>
...
<div class="modal fade" id="cancelarModalCitas" tabindex="-1" aria-hidden="true">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <form id='motivoform'>                
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <label for="motivoCancelarCitas" class="d-block dorada my-2"> 
                        <h4 class="dorada">Describa aquí su motivo</h4>
                    </label>
                    <div class="input-group has-validation">                
                        <textarea type="text" class="form-control mb-3" name="motivoCancelarCitas" id="_motivoCancelarCitas" maxlength="128" oninput="valMotivo(this)"></textarea>
                ...
                <div class="modal-footer justify-content-right">              
                    <div class="d-flex">
                        ...
                        <div class="p-2 flex-grow-1 justify-content-end">                        
                            <button type="button" class="btn btn-primary btn-primary-ccls rounded-pill" data-bs-dismiss="modal" onclick="cancelarCitas()">Confirmar</button>
                        </div>
                    </div>            
                </div>
            </form>
