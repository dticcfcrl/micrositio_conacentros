<nav class="nav navbar navbar-expand-xl navbar-light iq-navbar navbar_border">
  <div class="container-fluid navbar-inner">
    <button data-trigger="navbar_main" class="d-xl-none btn btn-primary rounded-pill p-1 pt-0 btnCMenu"  type="button">
      <svg width="20px" height="20px" viewBox="0 0 24 24">
        <path fill="currentColor" d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z"></path>
    </svg>
    </button>
    <div class="col-md-2 navbar-brand d-flex justify-content-center">
      <a href="{{route('ptrabajadoraspublic')}}" class="d-flex">
        <svg width="250" height="100" xmlns="http://www.w3.org/2000/svg">
          <image href="{{asset('images/ccls/logo.png')}}"  height="100" width="250" />
        </svg>
        <!-- <h5 class="logo-title">{{env('APP_NAME_CITAS')}}</h5> -->
      </a>
    </div>
    @include('partials.dashboard.horizontal-nav-ccl ')
    ...
    <div class="collapse navbar-collapse col-md-2" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ms-auto mb-2 mt-5 mb-lg-0 ">
        
        <li class="nav-item dropdown">
         
         <!--  <a href="#" class="search-toggle nav-link" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <svg width="30"  xmlns="http://www.w3.org/2000/svg">
              <image href="{{asset('images/ccls/search.svg')}}"   class="img-fluid rounded-circle" style="height: 30px; min-width: 30px; width: 30px;"  width="30" />
            </svg>
          ...
          <!-- <form class="d-flex formSearch">
            ...
            <button class="btn btn-outline-dark bntSearch" type="submit"></button>
          </form>-->
          <form class="d-flex formSearch">
            <input class="form-control" type="search" placeholder="Buscar" aria-label="Search">
            <button class="btn btn-outline-dark bntSearchnew" type="submit">
        ...
        <li class="nav-item dropdown d-flex mx-2">
          <a href="#" class="search-toggle  nav-link  d-flex justify-content-center align-items-center px-2" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            MENÚ
           <div class="burgerIcon d-inline-block mx-2"> </div>
          </a>
            ...
            <div class="card shadow-none m-0 border-0">
              <div class=" p-0 ">
                <ul class="list-group list-group-flush">
                  <li class="iq-sub-card list-group-item"><a class="p-0" href="#">Opción 1</a></li>
                  <li class="iq-sub-card list-group-item"><a class="p-0" href="#">Opción 2</a></li>
                  <li class="iq-sub-card list-group-item"><a class="p-0" href="#">Opción 3</a></li>
                  <li class="iq-sub-card list-group-item"><a class="p-0" href="#">Opción 4</a></li>
                  <li class="iq-sub-card list-group-item"><a class="p-0" href="#">Opción 5</a></li>
                </ul>
              </div>
            </div>
          </div>
