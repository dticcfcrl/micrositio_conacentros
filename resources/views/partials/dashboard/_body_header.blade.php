  ...
  <div class="container-fluid navbar-inner">
    <a href="{{route('dashboard')}}" class="navbar-brand">
      <svg width="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        <image href="{{asset('images/ccls/logoSolo.png')}}"  width="30"/>
    </svg> 
          ...
          <li class="nav-item dropdown">
            ...
            <img src="{{asset('images/avatars/avtar_3.png')}}" alt="User-Profile" class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded"> --}}
              <div class="caption ms-3 d-none d-md-block ">
                <h6 class="mb-0 caption-title">{{ ucfirst(auth()->user()->nombre) ?? 'Desconocido'  }}</h6>
                {{-- <p class="mb-0 caption-sub-title text-capitalize">{{ str_replace('_',' ',auth()->user()->user_type) ?? 'Marketing Administrator' }}</p> --}}
                <form method="POST" action="{{route('logout')}}">
                  @csrf
                  <a href="javascript:void(0)" class="dropdown-item dorada"
