        ...
        <table border="1">
            ...
            <tbody>                                
                ...
                <tr>
                    ...
                    <td colspan="3">{{isset($motivo) ? ucfirst($motivo) : 'Cita cancelada por usuario'}}</td>
                </tr>
            </tbody>
        </table>
        @if($correoInvalido)
            <p>No fue posible entregar el correo de cancelación de cita a la dirección registrada por el usuario: {{ $cancelarCita->correo }}.</p>
        @endif
    </body>
    <footer>
        <br>
